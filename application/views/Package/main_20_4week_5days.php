<table class="table livesearch">
	...
	<?php $count=0; ?>
	<?php if(is_array($main_20_4week_5days) && $main_20_4week_5days){ ?>
	<?php foreach ($main_20_4week_5days as $key => $val): ?>
		<tr>
			<td>
			...
			<td>
				<div class="btn-group">
					...
					<form action='<?php echo base_url();?>package/delete_20_4week_5days' method='post' name='packagedelete'>
