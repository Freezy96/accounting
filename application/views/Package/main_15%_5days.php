...
<table class="table livesearch">
	...
	<?php $count=0; ?>
	<?php if(is_array($main_15_5days) && $main_15_5days){ ?>
	<?php foreach ($main_15_5days as $key => $val): ?>
		<tr>
			<td>
			...
			<td>
				<div class="row">
					...
					<form action='<?php echo base_url();?>package/delete_15_5days' method='post' name='packagedelete'>
