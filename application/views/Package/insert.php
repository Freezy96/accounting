...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#10_5days" aria-controls="10_5days" role="tab" data-toggle="tab">10% / 5 days</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="25_4week_5days"><?php $this->load->view('package/insert_manual_5days_4week'); ?></div>
