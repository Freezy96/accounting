...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#20_4week_5days" aria-controls="20_4week_5days" role="tab" data-toggle="tab">20% / 4 Week/ 5 days</a></li>
    <li role="presentation"><a href="#25_4week_5days" aria-controls="25_week" role="tab" data-toggle="tab">25% / 4 Week / 5 days</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="25_4week_5days"><?php $this->load->view('package/insert_20%_4week_5days'); ?></div>
