<table class="table livesearch">
	...
	<?php $count=0; ?>
	<?php if(is_array($main_manual_5days_4week) && $main_manual_5days_4week){ ?>
	<?php foreach ($main_manual_5days_4week as $key => $val): ?>
		<tr>
			<td>
			...
			<td>
				<div class="btn-group">
					...
					<form action='<?php echo base_url();?>package/delete_manual_5days_4week' method='post' name='packagedelete'>
