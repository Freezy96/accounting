	...
	<?php foreach ($main_10_5days as $key => $val): ?>
		<tr>
			...
			<td>
				...
				<div class="row">
					<!-- <form action='<?php echo base_url();?>package/update_10_5days' method='post' name='packageedit'>
					<button class="btn btn-primary" value="<?php echo $val["packageid"]; ?>" name="agentidedit">Edit</button>
					</form> -->
					<form action='<?php echo base_url();?>package/delete_10_5days' method='post' name='packagedelete'>
