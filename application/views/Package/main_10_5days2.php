...
<table class="table livesearch">
	...
	<?php $count=0; ?>
	<?php if(is_array($main_10_5days2) && $main_10_5days2){ ?>
	<?php foreach ($main_10_5days2 as $key => $val): ?>
		<tr>
			<td>
			...
			<td>
				...
				<div class="row">
					<!-- <form action='<?php echo base_url();?>package/update_10_5days2' method='post' name='packageedit'>
					<button class="btn btn-primary" value="<?php echo $val["packageid"]; ?>" name="agentidedit">Edit</button>
					</form> -->
					<form action='<?php echo base_url();?>package/delete_10_5days2' method='post' name='packagedelete'>
