...
class Home_Model extends CI_Model{
    ...
    public function getuserdata(){
        // Run the query
        $this->db->select('a.accountid, a.oriamount, a.customerid, c.customername, a.amount, a.datee, a.interest, a.duedate, a.packageid, c.phoneno, ag.agentname, p.packagetypename');
