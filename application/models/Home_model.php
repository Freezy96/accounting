...
class Home_Model extends CI_Model{
    ...
    public function getuserdata(){
        ...
        $this->db->select('MAX(a.accountid), SUM(a.totalamount), a.refid, a.oriamount, a.customerid, c.customername, c.wechatname, a.amount, MIN(a.datee), a.interest, MAX(a.duedate), a.packageid, c.phoneno, ag.agentname, p.packagetypename, MAX(a.homeremind)');
